<?php
/*
Template Name: EduZone | Education Course & School Template + Admin Dashboard | DexignZone
...
/* ReCaptch Secret */
$recaptchaSecret = '/* put your Recaptacha secret Key */';

$dzEmailTo 		= "infoexemple.com";   /* Receiver Email Address */
$dzEmailFrom    = "EduZone Contact";
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'EduZone|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'EduZone|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."
